...
@Service
public class CanaisServices {

    public List<Canais> listarCanais() {
        throw new UnsupportedOperationException("Unimplemented method 'listarCanais'");
    }

    public Canais criarCanal(CanaisDTO canaisDTO) {
        throw new UnsupportedOperationException("Unimplemented method 'criarCanal'");
    }
